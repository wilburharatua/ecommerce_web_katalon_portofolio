...
WebUI.click(findTestObject('Login Page Objects/burgerMenuButton'))

WebUI.click(findTestObject('Login Page Objects/logOutButton'))

WebUI.verifyElementPresent(findTestObject('Login Page Objects/loginButton'), 0)
