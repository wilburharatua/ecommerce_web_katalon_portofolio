...
WebUI.setText(findTestObject('Cart Page Objects/firstname Field'), 'User')
...
WebUI.click(findTestObject('Cart Page Objects/finish button'))

WebUI.verifyElementText(findTestObject('Cart Page Objects/thankyou banner'), 'Thank you for your order!')

WebUI.click(findTestObject('Cart Page Objects/backtohomepage button'))
