...
WebUI.setText(findTestObject('Cart Page Objects/lastname Field'), '')
...
WebUI.verifyElementText(findTestObject('Cart Page Objects/error popup'), 'Error: Last Name is required')
