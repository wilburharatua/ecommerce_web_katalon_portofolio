...
WebUI.setText(findTestObject('Cart Page Objects/zipCode field'), '')

WebUI.click(findTestObject('Cart Page Objects/continue button'))

WebUI.verifyElementText(findTestObject('Cart Page Objects/error popup'), 'Error: Postal Code is required')
